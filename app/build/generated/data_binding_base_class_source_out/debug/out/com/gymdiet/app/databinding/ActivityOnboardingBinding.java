...
public final class ActivityOnboardingBinding implements ViewBinding {
  ...
  private ActivityOnboardingBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnNext, @NonNull View dot1, @NonNull View dot2, @NonNull View dot3,
      @NonNull LinearLayout indicatorContainer, @NonNull TextView tvSkip,
  ...
  public static ActivityOnboardingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOnboardingBinding((ConstraintLayout) rootView, btnNext, dot1, dot2, dot3,
          indicatorContainer, tvSkip, viewPager);
    }
